    ...
    <div class="card bg_black text-center mx-auto" style="max-width: 600px;">
      <div class="card-body">
        ...
        <p class="fs-4 fw-bold orange_color clickable_sign text-center" @click="goBack">
          <i class="bi bi-arrow-left text-white"></i> Data
        </p>
        ...
        <div class="row justify-content-center g-3 mb-4">
          <p class="fs-5 fw-bold text-white">Select Data Plan</p>
        ...
        <!-- Inputs -->
        <input type="number" class="form-control mb-4" placeholder="Enter Phone" v-model="phoneNumber">
    ...
    const randomString = Math.random().toString(36).substring(2, 10);
     ...
     this.reference = `${timestamp}${randomString}`;
      ...
      try {
        ...
        this.status = false
        this.$refs.closeButton.click();
        this.toast('error', 'Data Purchase Unsuccesfull')
        }
